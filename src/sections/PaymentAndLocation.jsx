  ...
  return (
    <section className="py-16 lg:py-24 mb-10 md:mb-15">
      ...
      <div className="text-center pt-20 md:pt-30">
        <p
          data-aos="fade-up"
          className="text-gray-700 text-[17px] lg:text-[25px] font-medium"
        >
          Bebas Pilih Cara Bayar Favoritmu
        </p>
        <p
          data-aos="fade-up"
          className="text-gray-700 text-[17px] lg:text-[19px] font-light mb-6"
        >
          Pembayaran tidak harus tunai
        </p>

        <div data-aos="fade-right" className="overflow-hidden w-full relative">
          <div
